...
$route['resep/detail/(:num)']['get']    = 'resep/detail/$1'; // get detail data resep
$route['user/detail/(:num)']['get']    = 'user/detail/$1'; // get detail data 
$route['user/update/(:num)']['put']    = 'user/update/$1'; // user update
$route['book']['get']          	       = 'book';
